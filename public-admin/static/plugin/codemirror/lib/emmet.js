(function (factory) {
    ...
    var markupSnippets = {
    	...
    	"!|html:5": "!!!+doc",
"f::pos|f::position":'{\r\n \
<?php \\$news = f::position(1,0,3); ?>\r\n \
<?php foreach(\\$news as \\$k=>\\$v): ?>\r\n \
<li> \r\n \
    <span class="img"><a href="<?=\\$v["url"]?>"><img src="<?=\\$v["titlepic"]?>"></a></span>\r\n \
    <p>\r\n \
        <a href="news_detail.asp?id=24"> <span><?php echo \\$v["title"] ?></span></a><br>\r\n \
        <?=date("Y-m-d",strtotime(\\$v["newstime"]))?><br>\r\n \
        <a href="<?=\\$v["url"]?>"><?=\\$v["smalltext"]?><span class="diff">详细>></span></a> \r\n \
    </p>\r\n \
</li>\r\n \
<?php endforeach; ?>}',
...
"f::loop_table|f::lt|looptable|loopt":"{\r\n \
<?php \\$list_generate=f::loop_table('xiaoshuo_chapter' /*要查询的表名*/,\r\n \
    [] /*要查询栏目id（多个字段用逗号分开）*/,\r\n \
    ['start'=>0 /*偏移量*/,\r\n \
    'number'=>10 /*查询数量*/,\r\n \
    'titleNum'=>30 /*标题字数*/,\r\n \
    'titleAddChar'=>'...' /*补充字符*/,\r\n \
    'showClass'=>false /*查询栏目名显示*/,\r\n \
    'position'=>'0' /*推荐属性*/,\r\n \
    'mustTitleImage'=>false /*标题图片，false为不限，true为必须包含*/,\r\n \
    'order'=>'id desc' /*排序方式*/,\r\n \
    'sql'=>'' /*附加SQL*/,\r\n \
    'schedule'=>false /*查询附表数据开关，调用实例：<?php echo \\$v['data']['content']?>*/,]) ?>\r\n \
    \r\n \
    <?php if(!empty(\\$list_generate)): ?>\r\n \
    <?php \\$num=1;/*起始编号*/ foreach(\\$list_generate as \\$v): ?>\r\n \
    <!--信息循环开始-->\r\n \
    <?php echo \\$num;\\$num++//信息编号 ?>\r\n \
    <?php echo \\$v['classid']//栏目ID ?>\r\n \
    <?php echo \\$v['classInfo']['classname']//栏目名称 ?>\r\n \
    <?php echo \\$v['classInfo']['classpath']//栏目链接 ?>\r\n \
    <?php echo \\$v['title']//标题 ?>\r\n \
    <?php echo \\$v['url']//信息链接 ?>\r\n \
    <?php if(is_array(\\$v['tag'])): ?>\r\n \
    <?php   foreach(\\$v['tag'] as \\$tag): ?>\r\n \
    <?php     echo \\$tag['tag']//标签 ?>\r\n \
    <?php   endforeach; ?>\r\n \
    <?php endif; ?>\r\n \
    <?php echo \\$v['titlepic']//图片 ?>\r\n \
    <?php echo cutstr(\\$v['smalltext'],240,'...') //内容简介 ?>\r\n \
    <?php echo date('Y-m-d H:i:s',\\$v['newstime'])//更新时间 ?>\r\n \
    <!--信息循环结束-->\r\n \
    <?php endforeach; ?>\r\n \
<?php endif; ?>}",
