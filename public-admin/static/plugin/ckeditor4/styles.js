 ...
 *  | HUTCMS
 *  +----------------------------------------------------------------------
 *  | Copyright (c) 2003-2022 http://hutcms.com All rights reserved.
 *  +----------------------------------------------------------------------
...
CKEDITOR.stylesSet.add('default', [
    ...
    {name: 'Styled Image (right)', element: 'img', attributes: {'class': 'right'}},
    {
        ...
        attributes: {border: '1', cellpadding: '5', cellspacing: '0', bordercolor: '#ccc'}, styles: {'border-collapse': 'collapse'}
    },
