...
<body>
    ...
    <div class="copyright">
        <a title="官方网站" href="http://www.hutcms.com">HUTCMS</a>
        <span>V<?php echo \hutcms\Core::version(); ?></span>
        <span style="color:#909399;font-size:12px;"> 基于ThinkPHP V<?php echo app()::VERSION ; ?> </span>
    </div>
    <?php if (\think\facade\App::isDebug()) { ?>
    <script>
